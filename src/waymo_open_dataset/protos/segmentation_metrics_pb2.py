...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'waymo_open_dataset/protos/segmentation_metrics.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_SEGMENTATIONMETRICSCONFIG'].fields_by_name['segmentation_types']._loaded_options = None
  _globals['_SEGMENTATIONMETRICSCONFIG'].fields_by_name['segmentation_types']._serialized_options = b'\020\001'
  _globals['_SEGMENTATIONMETRICS_PERCLASSIOUENTRY']._loaded_options = None
  _globals['_SEGMENTATIONMETRICS_PERCLASSIOUENTRY']._serialized_options = b'8\001'
